        ...
        <div class="max-w-2xl mx-auto p-6 bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700">
            ...
            <p class="text-sm text-zinc-500 mb-4">
                Sube un archivo <strong>.xlsx</strong> o <strong>.csv</strong> con encabezados:
                <code>nombre,email,dni,carrera,semestre,codigo_institucional,telefono,direccion</code>.
            </p>
