                        ...
                        <tr class="hover">
                            ...
                            <td>
                                <div class="flex justify-center gap-1">
                                    ...
                                    {{-- BOTÓN 'VER' AÑADIDO --}}
                                    <a href="{{ route('admin.books.show', $book->id) }}" wire:navigate
                                       class="btn btn-sm btn-ghost btn-circle" title="Ver detalle">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-.474 1.524-1.218 2.87-2.124 3.97m-9.836 0A14.95 14.95 0 0012 19c2.31 0 4.47-.534 6.38-1.47"></path></svg>
                                    </a>

                                    <a href="{{ route('admin.books.edit', $book->id) }}" wire:navigate
                                       class="btn btn-sm btn-info gap-2" title="Editar">
                                    ...
                                    <button
                                        ...
                                        class="btn btn-sm btn-error gap-2" title="Eliminar">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
